...
def get_segmentation_map(file: bytes):
    ...
    #         pool.submit(get_segments_for_mp, models[2]),
    #         pool.submit(get_segments_for_mp, models[3]),
    #         pool.submit(get_segments_for_mp, models[4]),
    #         pool.submit(get_segments_for_mp, models[5]),
    #     ]

    #     segmented_images = []
    #     for fut in futures:
    #         segmented_images.append(fut.result())
